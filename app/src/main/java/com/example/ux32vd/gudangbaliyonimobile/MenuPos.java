...
public class MenuPos extends AppCompatActivity {
    ...
    String DIRECTORY = Environment.getExternalStorageDirectory().getPath() + "/Baliyoni/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_pos);
        ...
        // Dialog Function
        dialog = new Dialog(MenuPos.this);
